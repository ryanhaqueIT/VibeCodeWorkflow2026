...
### Beads Utility (Authoritative Rules)
You MUST follow the Beads filesystem rules below in addition to the `bd` CLI usage.

#### The Bead Plan (`.agent/workflows/vibe-plan.md`)
...
#### The Thread State (`.agent/work/vibe-state.json`)

      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          >
            ...
            read the existing documents and continue from where you left off, or start fresh with
            a new plan?
          </p>
        </div>
        ...
        <div className="p-5 pt-0 space-y-3">
          <button
            ...
            style={{
              ...
              boxShadow: focusedButton === 'continue'
          ...
          >
            ...
            <kbd className="px-1.5 py-0.5 rounded text-[10px] font-mono" style={{ backgroundColor: theme.colors.bgActivity }}>Esc</kbd> to cancel
          </p>
        </div>
      </div>
    </div>

...
describe('Debug Package Collectors', () => {
  ...
  describe('collectSystemInfo', () => {
    it('should collect OS, hardware, and app information', async () => {
      const { collectSystemInfo } = await import(
        '../../../main/debug-package/collectors/system'
      );
  ...
  describe('collectSettings - sanitizePath', () => {
    it('should replace home directory with ~', async () => {
      const { sanitizePath } = await import(
        '../../../main/debug-package/collectors/settings'
      );
  ...
  describe('collectSettings', () => {
    it('should sanitize sensitive keys in settings', async () => {
      const { collectSettings } = await import(
        '../../../main/debug-package/collectors/settings'
      );
    ...
    it('should handle nested objects with sensitive keys', async () => {
      ...
      expect((result.raw.agent as any).claude.endpoint).toBe(
  ...
  describe('collectSessions', () => {
    it('should extract session metadata without conversation content', async () => {
      const { collectSessions } = await import(
        '../../../main/debug-package/collectors/sessions'
      );
  ...
  describe('collectAgents', () => {
    it('should collect agent info with sanitized paths', async () => {
      const { collectAgents } = await import(
        '../../../main/debug-package/collectors/agents'
      );
  ...
  describe('collectLogs', () => {
    it('should collect recent logs with level counts', async () => {
      ...
      const { collectLogs } = await import(
        '../../../main/debug-package/collectors/logs'
      );
  ...
  describe('collectErrors', () => {
    it('should collect session errors and error logs', async () => {
      ...
      const { collectErrors } = await import(
        '../../../main/debug-package/collectors/errors'
      );
  ...
  describe('collectBatchState', () => {
    it('should collect Auto Run state from sessions', async () => {
      const { collectBatchState } = await import(
        '../../../main/debug-package/collectors/batch-state'
      );
      ...
      const session1 = result.activeSessions.find(
      ...
      const session3 = result.activeSessions.find(
        (s) => s.sessionId === 'session-3'
      );
  ...
  describe('collectExternalTools', () => {
    it('should collect external tools availability', async () => {
      ...
      const { isCloudflaredInstalled } = await import(
        '../../../main/utils/cliDetection'
      );
      ...
      const { collectExternalTools } = await import(
        '../../../main/debug-package/collectors/external-tools'
      );
    ...
    it('should handle failures gracefully', async () => {
      ...
      vi.mocked(isCloudflaredInstalled).mockRejectedValue(
  ...
  describe('collectWebServer', () => {
    it('should collect web server state', async () => {
      ...
      const { collectWebServer } = await import(
        '../../../main/debug-package/collectors/web-server'
      );
      ...
      const mockWebServer = {
        ...
        getLiveSessions: vi.fn().mockReturnValue([
          { id: 'session-1', enabledAt: Date.now() - 1000 },
        ]),
      };
  ...
  describe('collectStorage', () => {
    it('should collect storage paths and sizes with sanitization', async () => {
      ...
      const { collectStorage } = await import(
        '../../../main/debug-package/collectors/storage'
      );
  ...
  describe('collectGroupChats', () => {
    it('should collect group chat metadata without message content', async () => {
      ...
      const { collectGroupChats } = await import(
        '../../../main/debug-package/collectors/group-chats'
      );

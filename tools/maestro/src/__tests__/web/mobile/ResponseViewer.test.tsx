...
describe('ResponseViewer', () => {
  ...
  describe('Swipe gestures - vertical dismiss', () => {
    ...
    it('does not dismiss on swipe up', () => {
      ...
      fireEvent.touchStart(dialog, createTouchEvent('touchstart', [{ clientX: 100, clientY: 100 }]));
  ...
  describe('Swipe gestures - horizontal navigation', () => {
    ...
    it('navigates to next on swipe left past threshold', () => {
      ...
      fireEvent.touchStart(dialog, createTouchEvent('touchstart', [{ clientX: 200, clientY: 100 }]));
      // First move to determine direction (horizontal - deltaX > deltaY, past 10px threshold)
  ...
  describe('Pinch-to-zoom', () => {
    it('zooms in on pinch out gesture', () => {
      ...
      fireEvent.touchStart(dialog, createTouchEvent('touchstart', [
        { clientX: 100, clientY: 100 },
        { clientX: 110, clientY: 100 },
      ]));

      // Move fingers apart (pinch out)
      fireEvent.touchMove(dialog, createTouchEvent('touchmove', [
  ...
  describe('Double-tap to zoom', () => {
    it('zooms in on double tap when not zoomed', async () => {
      ...
      if (contentArea) {
        // First tap
        fireEvent.touchStart(contentArea, createTouchEvent('touchstart', [{ clientX: 100, clientY: 100 }]));
  ...
  describe('Edge cases', () => {
    it('handles currentIndex out of bounds gracefully', () => {
      const allResponses = [
        createMockResponseItem({ sessionId: 's1', response: createMockResponse({ text: 'First' }) }),
      ];

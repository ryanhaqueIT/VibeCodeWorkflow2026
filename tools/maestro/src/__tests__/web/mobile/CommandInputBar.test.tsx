...
import { CommandInputBar, type CommandInputBarProps, type InputMode } from '../../../web/mobile/CommandInputBar';
...
vi.mock('../../../web/mobile/SlashCommandAutocomplete', () => ({
  SlashCommandAutocomplete: vi.fn(({ isOpen, inputValue, onSelectCommand, onClose, selectedIndex }) => (
    isOpen ? (
...
vi.mock('../../../web/mobile/QuickActionsMenu', () => ({
  QuickActionsMenu: vi.fn(({ isOpen, onClose, onSelectAction, inputMode, anchorPosition, hasActiveSession }) => (
    isOpen ? (
...
describe('CommandInputBar', () => {
  ...
  describe('Slash Command Autocomplete', () => {
    ...
    it('does not show slash command button in terminal mode', () => {
      renderComponent({ inputMode: 'terminal' });
      expect(screen.queryByRole('button', { name: /open slash commands/i })).not.toBeInTheDocument();
    });

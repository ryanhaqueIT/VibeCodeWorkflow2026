...
describe('useWebSocket', () => {
  ...
  describe('Connection Lifecycle', () => {
    ...
    it('uses custom URL when provided', () => {
      const { result } = renderHook(() =>
        useWebSocket({ url: 'ws://custom.host/ws' })
      );
    ...
    it('sets state to connected when receiving connected message without auth', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onConnectionChange } })
      );
  ...
  describe('Message Handling', () => {
    it('handles sessions_list message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onSessionsUpdate } })
      );
    ...
    it('handles session_state_change message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onSessionStateChange } })
      );
    ...
    it('handles session_added message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onSessionAdded } })
      );
    ...
    it('handles session_removed message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onSessionRemoved } })
      );
    ...
    it('handles active_session_changed message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onActiveSessionChanged } })
      );
    ...
    it('handles session_exit message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onSessionExit } })
      );
    ...
    it('handles user_input message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onUserInput } })
      );
    ...
    it('handles theme message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onThemeUpdate } })
      );
    ...
    it('handles custom_commands message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onCustomCommands } })
      );
    ...
    it('handles autorun_state message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onAutoRunStateChange } })
      );
    ...
    it('handles tabs_changed message', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onTabsChanged } })
      );
    ...
    it('handles pong message silently', () => {
      ...
      const { result } = renderHook(() =>
        useWebSocket({ handlers: { onMessage } })
      );
  ...
  describe('Ping/Pong', () => {
    ...
    it('starts automatic ping interval on connection', () => {
      const { result } = renderHook(() =>
        useWebSocket({ pingInterval: 5000 })
      );
...
describe('Type Exports', () => {
  it('exports WebSocketState type', () => {
    ...
    expect(['disconnected', 'connecting', 'connected', 'authenticating', 'authenticated']).toContain(state);
  });

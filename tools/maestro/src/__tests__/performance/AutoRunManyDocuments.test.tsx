...
vi.mock('lucide-react', () => ({
  ...
  FolderOpen: ({ className }: { className?: string }) => (
    <span data-testid="folder-open" className={className}>📂</span>
  ),
  ...
  Maximize2: ({ className }: { className?: string }) => <span data-testid="maximize-icon" className={className}>⛶</span>,
  Image: ({ className }: { className?: string }) => <span data-testid="image-icon" className={className}>🖼</span>,
  HelpCircle: ({ className }: { className?: string }) => <span data-testid="help-icon" className={className}>?</span>,
  Play: ({ className }: { className?: string }) => <span data-testid="play-icon" className={className}>▶</span>,
  Square: ({ className }: { className?: string }) => <span data-testid="square-icon" className={className}>■</span>,
  Eye: ({ className }: { className?: string }) => <span data-testid="eye-icon" className={className}>👁</span>,
  Edit: ({ className }: { className?: string }) => <span data-testid="edit-icon" className={className}>✎</span>,
  Edit3: ({ className }: { className?: string }) => <span data-testid="edit3-icon" className={className}>✎</span>,
 ...
 */
function generateTaskCounts(documents: string[]): Map<string, { completed: number; total: number }> {
...
const createSelectorDefaultProps = (overrides: Partial<React.ComponentProps<typeof AutoRunDocumentSelector>> = {}) => ({
...
const createAutoRunDefaultProps = (overrides: Partial<React.ComponentProps<typeof AutoRun>> = {}) => ({
  theme: createMockTheme(),
...
describe('AutoRun Many Documents Performance', () => {
  ...
  describe('Folder with 500+ Documents', () => {
    ...
    it('handles rapid document selection changes', () => {
      ...
      for (let i = 0; i < 20; i++) {
        fireEvent.click(screen.getByRole('button', { name: new RegExp(documents[i * 25] || documents[0], 'i') }));
  ...
  describe('AutoRun Component with Many Documents in List', () => {
    ...
    it('loads new document content when switching in large list', () => {
      ...
      rerender(<AutoRun
        {...props}
        selectedFile={documents[100]}
        content="# Document 100 Content"
      />);
  ...
  describe('Edge Cases with Many Documents', () => {
    ...
    it('handles very long document names', () => {
      const longName = 'this-is-a-very-long-document-name-that-might-cause-layout-issues-in-the-dropdown-selector-component';

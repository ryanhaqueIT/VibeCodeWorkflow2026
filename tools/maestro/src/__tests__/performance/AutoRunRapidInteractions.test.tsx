...
function generateSessionData(count: number): Array<{ id: string; content: string; folderPath: string }> {
...
describe('AutoRun Rapid User Interactions Performance', () => {
  ...
  describe('Rapid Mode Toggling', () => {
    ...
    it('handles 50 rapid mode toggles', () => {
      ...
      expect(screen.queryByRole('textbox') || screen.queryByTestId('react-markdown')).toBeInTheDocument();
    });

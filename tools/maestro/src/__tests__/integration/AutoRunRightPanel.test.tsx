...
const RightPanelTestWrapper = ({
  ...
  const handleStateChange = (state: { mode: 'edit' | 'preview'; cursorPosition: number; editScrollPos: number; previewScrollPos: number }) => {
    setSession(prev => ({
      ...prev,
...
describe('Auto Run + RightPanel Integration', () => {
  ...
  describe('Panel Resize Does Not Lose Content', () => {
    ...
    it('maintains scroll position during resize', async () => {
      ...
      Object.defineProperty(textarea, 'scrollTop', { value: 150, writable: true, configurable: true });

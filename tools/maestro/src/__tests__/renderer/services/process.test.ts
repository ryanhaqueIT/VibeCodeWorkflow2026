...
import { processService, ProcessConfig, ProcessDataHandler, ProcessExitHandler, ProcessSessionIdHandler } from '../../../renderer/services/process';
...
describe('processService', () => {
  ...
  describe('kill', () => {
    ...
    test('handles kill on already-dead process', async () => {
      ...
      await expect(processService.kill('dead-session')).rejects.toThrow('Process already terminated');
    });
  });

...
describe('HistoryDetailModal', () => {
  ...
  describe('Entry Types', () => {
    ...
    it('should show validated indicator with double check for validated entries', () => {
      ...
      const validatedIndicator = screen.getByTitle('Task completed successfully and human-validated');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle entry with multiple ANSI codes', () => {
      const ansiText = '\x1b[1m\x1b[31mBold Red\x1b[0m \x1b[32mGreen\x1b[0m \x1b[4mUnderline\x1b[0m';
      render(
        <HistoryDetailModal
          theme={mockTheme}

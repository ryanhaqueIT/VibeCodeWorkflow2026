...
const createMockParsedFile = (overrides: Partial<ParsedFileDiff> = {}): ParsedFileDiff => ({
  ...
  parsedDiff: [{
    ...
    hunks: [{
      ...
      content: '@@ -1,3 +1,4 @@',
      changes: [
        { type: 'normal', content: ' const a = 1;', isNormal: true, oldLineNumber: 1, newLineNumber: 1 },
        { type: 'insert', content: '+const b = 2;', isInsert: true, lineNumber: 2 },
        { type: 'normal', content: ' const c = 3;', isNormal: true, oldLineNumber: 2, newLineNumber: 3 },
      ],
    }],
  }],
  isBinary: false,
          ...
          parsedDiff: [{
            ...
            hunks: [{
              ...
              changes: [
                ...
                { type: 'normal', content: ' const c = 3;', isNormal: true, oldLineNumber: 3, newLineNumber: 1 },
              ],
            }],
          }],
        }),

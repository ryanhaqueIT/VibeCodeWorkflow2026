...
describe('Wizard Theme Styles', () => {
  beforeEach(() => {
    ...
    mockMaestro.agents.get.mockResolvedValue({ id: 'claude-code', name: 'Claude Code', path: '/test/path' });
    ...
    mockMaestro.autorun.saveImage.mockResolvedValue({ success: true, relativePath: 'images/test.png' });
  ...
  describe('WizardResumeModal Theme Rendering', () => {
    ...
    it.each(sampleThemes)('should show progress bar with accent color for %s theme', async (themeId) => {
      const theme = THEMES[themeId];
  ...
  describe('TourStep Theme Rendering', () => {
    ...
    it.each(sampleThemes)('should apply theme colors to step number badge for %s theme', (themeId) => {
      const theme = THEMES[themeId];
  ...
  describe('Color Contrast Validation', () => {
    ...
    it.each(themeIds)('should have sufficient contrast between accent and accentForeground for %s theme', (themeId) => {
      const theme = THEMES[themeId];
    ...
    it.each(themeIds)('should have sufficient contrast between bgMain and textMain for %s theme', (themeId) => {
      const theme = THEMES[themeId];

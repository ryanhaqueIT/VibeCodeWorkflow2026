...
vi.mock('../../../renderer/components/MaestroSilhouette', () => ({
  MaestroSilhouette: ({ variant, size, style }: { variant: string; size: number; style?: React.CSSProperties }) => (
...
describe('AchievementCard', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders with correct theme colors', () => {
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={baseAutoRunStats} />);
  ...
  describe('Badge Progression Bar', () => {
    ...
    it('renders 11 badge segments', () => {
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={firstBadgeStats} />);
  ...
  describe('Tooltip Positioning', () => {
    it('positions tooltip left for level 1-2 badges', () => {
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={level5Stats} />);
    ...
    it('positions tooltip right for level 10-11 badges', () => {
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={maxLevelStats} />);
  ...
  describe('Color Interpolation', () => {
    ...
    it('uses accent color for levels 1-3 (unlocked)', () => {
      ...
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={level3Stats} />);
    ...
    it('uses gold color (#FFD700) for levels 4-7 (unlocked)', () => {
      ...
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={level7Stats} />);
  ...
  describe('Progress Percentage', () => {
    it('shows progress toward next badge', () => {
      ...
      const { container } = render(<AchievementCard theme={mockTheme} autoRunStats={halfwayStats} />);
